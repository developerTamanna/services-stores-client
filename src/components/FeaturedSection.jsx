...
const FeaturedSection = () => {
  ...
  return (
    <div className="bg-black text-white py-10 px-4 md:px-10 mt-10">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6  mt-10 md:mt-20" >
        {services.map((service) => (
          <div
            key={service._id}
            className="bg-gray-900 rounded-xl shadow-lg p-5 hover:scale-105 duration-300"
          >
            <img
              src={service.image}
              alt={service.title}
            ...
            <p className="text-green-400 font-bold mb-4">${service.price}</p>

            <Link
              to={`/details/${service._id}`} // ✅ Link set করা হয়েছে
